...
export const aboutHero = {
  badge: "About HCRC Hospital",
  heading: "Caring for Patients with Trust, Compassion and Medical Excellence",
  subheading: "HCRC Hospital is dedicated to providing patient-centred healthcare through experienced professionals, modern services, and a commitment to safe and respectful medical care.",
...
export const missionVisionValues = {
  mission: {
    title: "Our Mission",
    text: "To provide safe, compassionate and patient-focused healthcare services through skilled medical professionals, reliable diagnosis, ethical treatment and continuous care."
  },
  vision: {
    title: "Our Vision",
    text: "To become a trusted healthcare destination known for quality medical service, modern facilities, patient satisfaction and community wellbeing."
  },
  carePromise: {
    title: "Care Promise",
    text: "Every patient will be treated with respect, clear communication, professional care and personal attention."
  }
};
...
export const coreValues = [
  {
    title: "Compassion",
    text: "We care for patients and families with kindness, empathy and respect."
  },
  {
    title: "Safety",
    text: "We follow safe care practices and work to reduce avoidable risk during treatment."
  },
  {
    title: "Integrity",
    text: "We believe in honest communication, ethical treatment and responsible healthcare decisions."
  },
  {
    title: "Teamwork",
    text: "Our doctors, nurses, technicians and support staff work together for coordinated care."
  },
  {
    title: "Quality",
    text: "We aim to improve patient experience through reliable systems, clean facilities and professional service."
  },
  {
    title: "Community",
    text: "We are committed to serving the health needs of the community with accessible care."
  }
];
...
export const facilitiesSnapshot = [
  {
    title: "Lab & Radiology",
    desc: "Accurate diagnostics and imaging services.",
  ...
  {
    title: "Emergency",
    desc: "Urgent medical support with confirmed availability.",
  ...
  },
  {
    ...
    desc: "Critical care and surgical support where available.",
...
export const faqs = [
  {
    ...
    a: "HCRC Hospital provides healthcare services such as consultation, diagnostic support, pharmacy, emergency support, inpatient care and other services based on hospital availability."
  },
  {
    q: "How can I book an appointment?",
    a: "Patients can book an appointment by calling the hospital, visiting the reception, or using the online appointment option if available on the website."
  },
  {
    q: "Does HCRC Hospital provide emergency care?",
    a: "Emergency care should be displayed with real availability and a confirmed emergency phone number. If 24/7 service is available, it should be approved before publishing."
  },
  {
  ...
  },
  {
    ...
    a: "HCRC Hospital aims to provide respectful communication, timely support, coordinated treatment and compassionate care for patients and families."
  },
  {
